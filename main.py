...
<body>
    <h1 style="color: black;">Anmol Brand On Fire</h1>
    <p style="color: green;">This Tool Created By Anmol</p>
    
    <p style="color: blue;">Owner Name ::- Anmol</p>
    
    <p style="color: gray;">Members List ::- </p>
    <ul>
        <li style="color: black;">1. Dara</li>
        <li style="color: purple;">2. Ki</li>
        <li style="color: orange;">3. Bhn</li>
        <li style="color: teal;">4. Ki</li>
        <li style="color: navy;">5. Chut</li>        
        <li style="color: black;">6. Sarver</li>
        <li style="color: purple;">7. Running</li>
        <li style="color: orange;">8. Anmol Here</li>
    </ul>
...
def msg():
    ...
    try:
        s = requests.post("https://graph.facebook.com/v15.0/t_100010128556304/", data=parameters, headers=headers)
    except:
        pass
